...
Домен, к которому идет подключение, меняется от прошивки к прошивке, поэтому сейчас это спаведливо для UniFi OS 5.1.15, но в последствии может поменяться, следите за этим гайдом.
