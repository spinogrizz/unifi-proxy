...
Если по какой-то причине ваша версия UniFi Network слишком старая или не позволяет задавать DNS записи, но у вас есть доступ к SSH, то можно прописать IP адрес `103.167.234.147` напрямую в файл **/etc/hosts** на вашем устройстве или роутере:
